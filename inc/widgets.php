...
if ( ! function_exists( 'understrap_widgets_init' ) ) {
	...
	function understrap_widgets_init() {
		...
		register_sidebar(
			array(
				'name'          => __( 'Ads Post', 'understrap' ),
				'id'            => 'custom-adspost',
				'description'   => __( 'Ads Post widget area home page', 'understrap' ),
				'before_widget' => '<div id="%1$s" class="widget %2$s h-100 custom-card text-center fw-light">',
				'after_widget'  => '</div>',
				'before_title'  => '',
				'after_title'   => '',
			)
		...
		register_sidebar(
			array(
				...
				'before_widget' => '<div id="%1$s" class="footer-widget %2$s dynamic-classes mb-3 mb-md-0 pb-3 pb-md-0">',
