	...
	function understrap_entry_footer() {
		...
		if ( 'post' === get_post_type() ) {
			...
			if ( $tags_list ) {
				...
				printf( '<span class="d-flex flex-wrap algin-items-center tags-links mb-3"><span class="btn btn-warning btn-sm text-white"><i class="fa fa-tag me-1 text-white"></i>' .__( 'Tags', 'understrap' ). '</span>' . esc_html__( '%s', 'understrap' ) . '</span>', $tags_list ); 
			}
		}
